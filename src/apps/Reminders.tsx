...
export const Reminders: React.FC = () => {
    ...
    return (
        <div className="flex w-full h-full bg-white text-black font-sans">
            {/* Sidebar */}
            <div className="w-64 bg-[#F5F5F7] flex flex-col border-r border-gray-200">
                <div className="p-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-6">
                        <div className={clsx("bg-white rounded-lg p-2 shadow-sm cursor-pointer", activeList === 'Today' && "ring-2 ring-blue-500")} onClick={() => setActiveList('Today')}>
                        ...
                        <div className={clsx("bg-white rounded-lg p-2 shadow-sm cursor-pointer", activeList === 'Scheduled' && "ring-2 ring-blue-500")} onClick={() => setActiveList('Scheduled')}>
                            <div className="flex justify-between items-start mb-1">
                        ...
                        <div className={clsx("bg-white rounded-lg p-2 shadow-sm cursor-pointer", activeList === 'All' && "ring-2 ring-blue-500")} onClick={() => setActiveList('All')}>
                            <div className="flex justify-between items-start mb-1">
                        ...
                        <div className={clsx("bg-white rounded-lg p-2 shadow-sm cursor-pointer", activeList === 'Flagged' && "ring-2 ring-blue-500")} onClick={() => setActiveList('Flagged')}>
                            <div className="flex justify-between items-start mb-1">
                    ...
                    <div
                        className={clsx("flex items-center gap-3 px-2 py-1.5 rounded-md cursor-pointer", activeList === 'Reminders' ? "bg-[#d1d1d6]" : "hover:bg-black/5")}
                    ...
                    <div
                        className={clsx("flex items-center gap-3 px-2 py-1.5 rounded-md cursor-pointer", activeList === 'Work' ? "bg-[#d1d1d6]" : "hover:bg-black/5")}
            ...
            <div className="flex-1 bg-white flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-8 py-4">
                    {filteredReminders.map(r => (
                        <div key={r.id} className="flex items-start gap-3 py-2 border-b border-gray-100 group">
                            <div
                                className={clsx(
