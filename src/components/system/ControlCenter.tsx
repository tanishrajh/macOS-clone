...
export const ControlCenter: React.FC<ControlCenterProps> = ({ isOpen, onClose }) => {
    ...
    // In a real app we'd use a more robust click-outside hook

    return (
        <>
            <div className="fixed inset-0 z-[5000] bg-transparent" onClick={onClose} />
            <div className="absolute top-9 right-2 w-80 bg-[#E5E5E5]/90 backdrop-blur-2xl border border-white/20 rounded-2xl shadow-2xl p-3 z-[5001] text-black">
                <div className="grid grid-cols-2 gap-3 mb-3">
                    {/* Network/Connectivity Block */}
                    <div className="bg-white/50 rounded-xl p-3 flex flex-col gap-3 shadow-sm">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex-1 bg-white/50 rounded-xl p-3 flex items-center gap-3 shadow-sm hover:bg-white/60 transition-colors cursor-pointer">
                ...
                {/* Display Slider */}
                <div className="bg-white/50 rounded-xl p-3 mb-3 shadow-sm">
                    <div className="flex flex-col gap-2">
                        <span className="text-xs font-semibold px-1">Display</span>
                        <div className="h-6 bg-white/80 rounded-full relative overflow-hidden group cursor-pointer border border-gray-200">
                            <div className="absolute inset-y-0 left-0 bg-white w-[70%]" />
                ...
                <div className="bg-white/50 rounded-xl p-3 mb-3 shadow-sm">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="h-6 bg-white/80 rounded-full relative overflow-hidden group cursor-pointer border border-gray-200">
                            <div className="absolute inset-y-0 left-0 bg-white w-[50%]" />
