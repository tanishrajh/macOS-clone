...
export const ControlCenter: React.FC<ControlCenterProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <div className="absolute top-9 right-2 w-80 bg-[#E5E5E5]/90 dark:bg-[#1e1e1e]/90 backdrop-blur-2xl border border-white/20 dark:border-white/10 rounded-2xl shadow-2xl p-3 z-[5001] text-black dark:text-white transition-colors duration-300">
