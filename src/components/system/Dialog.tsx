            ...
            {open && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed z-[10000] top-1/2 left-1/2 w-80 bg-[#F5F5F7]/90 dark:bg-[#2c2c2e]/90 backdrop-blur-xl rounded-xl shadow-2xl border border-white/20 overflow-hidden"
                        style={{ transform: 'translate(-50%, -50%)' }} // Fallback if motion overrides
                    >
                        {/* Header/Icon Area */}
                        ...
                        <div className="flex border-t border-gray-300 dark:border-white/10 divide-x divide-gray-300 dark:divide-white/10">
                            {secondaryAction && (
                                <button
                                    className="flex-1 py-3 text-xs font-medium text-black dark:text-white hover:bg-black/5 dark:hover:bg-white/5 active:bg-black/10 transition-colors focus:outline-none"
                            ...
                            {primaryAction && (
                                <button
                                    className={clsx(
                                        "flex-1 py-3 text-xs font-bold hover:bg-black/5 dark:hover:bg-white/5 active:bg-black/10 transition-colors focus:outline-none",
